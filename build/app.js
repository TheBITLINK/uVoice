...
var _browser = require('./runtimes/browser');
...
var App = function () {
  function App() {
    ...
    this.common = new _common2.default();
    this.editor = new _editor2.default();
    this.runtime = window.runtime || new _browser2.default();
  }
...
},{"./core/common":2,"./core/editor":4,"./runtimes/browser":7,"jquery":8}],2:[function(require,module,exports){
'use strict';
...
var Common = function () {
  ...
  _createClass(Common, [{
    ...
    value: function init() {
      ...
      // Temporary
      (0, _jquery2.default)('.uv-toolbar').on('click', 'button', function () {
        _this.showTooltip('Not yet supported.');
      });
    }
    ...
    value: function showTooltip(text) {
      var tooltip = (0, _jquery2.default)('<div class="overlayTooltip"></div>').text(text).appendTo('#uv-overlay');
...
},{"./notes":3,"jquery":8}],3:[function(require,module,exports){
"use strict";
...
var _pianoRoll = require('./pianoRoll');
...
var Editor = function () {
  function Editor() {
    ...
    this.pianoRoll = new _pianoRoll2.default((0, _jquery2.default)('.uv-pianoRoll')[0]);
    this.mode = 'select';
    this.registerEvents();
  }
  ...
  _createClass(Editor, [{
    ...
    value: function registerEvents() {
      (0, _jquery2.default)('#uv-logo').click(function () {
        (0, _jquery2.default)('#uv-main-sidebar').sidebar('toggle');
      });
    }
  }]);
...
},{"./pianoRoll":5,"jquery":8}],5:[function(require,module,exports){
'use strict';
...
var PianoRoll = function () {
  ...
  _createClass(PianoRoll, [{
    ...
    value: function playNote(note) {
      var name = note.getAttribute ? note.getAttribute('name') : note;
    ...
    value: function stopAll() {
      ...
      try {
        for (var _iterator = Object.keys(this.playing)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
 ...
 * @extends Runtime
 */
var BrowserRuntime = function (_Runtime) {
  _inherits(BrowserRuntime, _Runtime);

  function BrowserRuntime() {
    _classCallCheck(this, BrowserRuntime);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(BrowserRuntime).apply(this, arguments));
  }

  _createClass(BrowserRuntime, [{
    key: 'init',
